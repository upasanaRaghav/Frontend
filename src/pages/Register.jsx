...
import registerImg from "../assets/images/sign.svg";
              ...
              <div className="flex flex-wrap gap-4 justify-center md:ml-16">
                ...
                <div className="flex flex-col justify-center my-2">
                  ...
                  <input
                    required
                    name="profileImage"
                    className="font-robotoNormal w-full px-3 py-1.5 text-base font-normal border border-solid border-gray-100 rounded cursor-pointer focus:border-primary focus:outline-none"
                    type="file"
                    id="profileImg"
