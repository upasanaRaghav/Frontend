...
import landingTitle from "../assets/images/buy.svg";
    ...
    <div>
      ...
      <main className="flex flex-col items-center my-16">
        <div className="md:w-2/3">
          ...
          Renting Made Easy:{" "}
            <span className="text-secondary"> List & Manage.</span> All Here. 
          </h1>
          <p className="mt-8 text-center text-yellow-400 w-4/5 mx-auto">
          Finding Your Dream Home Shouldn't Be a Nightmare.
Rentify simplifies renting for everyone. Landlords list & manage, 
tenants find their perfect match. All in one place.
          </p>
        </div>
        ...
        <div className="md:w-2/4">
          <img src={landingTitle} alt="landing title" className="w-full" p-4/>
        </div>
